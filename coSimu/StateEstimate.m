...
idx.idx_zPF = [ResultData.allLineIdx; ResultData.allTransfIdx];
idx.idx_zPT = [ResultData.allLineIdx; ResultData.allTransfIdx];
idx.idx_zPG = [ResultData.allGenIdx];
idx.idx_zVa = [];
idx.idx_zQF = [ResultData.allLineIdx; ResultData.allTransfIdx];
idx.idx_zQT = [ResultData.allLineIdx; ResultData.allTransfIdx];
idx.idx_zQG = ResultData.allGenIdx;
idx.idx_zVm = ResultData.allBusIdx;

%% specify measurements
measure.PF = [CurrentStatus.plineHeadMeas;CurrentStatus.ptransfHeadMeas]/CurrentStatus.baseMVA;
measure.PT = [CurrentStatus.plineTailMeas;CurrentStatus.ptransfTailMeas]/CurrentStatus.baseMVA;
measure.PG = [CurrentStatus.genPMeasKw/1e3/CurrentStatus.baseMVA];
measure.Va = [];
measure.QF = [CurrentStatus.qlineHeadMeas;CurrentStatus.qtransfHeadMeas]/CurrentStatus.baseMVA;
measure.QT = [CurrentStatus.qlineTailMeas;CurrentStatus.qtransfTailMeas]/CurrentStatus.baseMVA;
measure.QG = CurrentStatus.genQMeasKva/1e3/CurrentStatus.baseMVA;
