...
mpc.gen(:,[4,5]) = 2*mpc.gen(:,[4,5]);
mpc.gen([3,4,5,6],2) = 1*1e-3;
...
mpc.branch = [
	...
	6	9	0	0.208	0	9900	0	0	1	0	1	-360	360;
	6	10	0	0.556	0	9900	0	0	1	0	1	-360	360;
...
% 	6	10	0	0.556	0	9900	0	0	0.969	0	1	-360	360;
	...
	4	12	0	0.256	0	9900	0	0	1	0	1	-360	360;
%     	4	12	0	0.256	0	9900	0	0	0.932	0	1	-360
%     	360;
	...
	28	27	0	0.396	0	9900	0	0	1	0	1	-360	360;
%     	28	27	0	0.396	0	9900	0	0	0.968	0	1	-360
%     	360;
